		...
		data: [
			{
				...
				type: "doughnut",
				dataPoints: [
					{  y: 39, name: "Pré-Cadastro" },
					{  y: 11, name: "Cad Finalizado" }
				]
			}
		]
	});
		...
		data: [
			{
				...
				dataPoints: [
					{ y: 16,  label: "Outros" },
					{ y: 4, label: "Minas Gerais" },
					{ y: 5,  label: "Rio de Janeiro" },
					{ y: 7, label: "Fortaleza" },
					{ y: 11, label: "Natal" },
					{ y: 12, label: "São Paulo" }
				]
			}
		]
	});
